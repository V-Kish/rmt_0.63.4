...
class CurrentUserImpl {
  ...
  set userToken(userToken) {
    this._user.userToken = userToken;
  }
  get deviceToken() {
  ...
  set userTheme(value) {
    this._user.userTheme = value;
  }
  get userTheme() {
    return this._user.userTheme;
  }
  set userName(value) {
...
export function currentUserOld(): CurrentUserImpl {
  // @ts-ignore
