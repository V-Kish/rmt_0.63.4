...
import { StackNavigationState, TypedNavigator, DefaultNavigatorOptions, StackRouterOptions, DrawerNavigationState, DrawerRouterOptions } from "@react-navigation/native";
